...
export default function Buttons() {
  ...
  return (
    <div className="bg-green-100">
      ...
      <br className="h-28px" />
      <h1 className="font-extrabold mb-2 text-black pl-6">
        Special / Image
      </h1>
      <br className="h-28px" />
      <div className="pl-6">
      <SpecialOrImage color="bg-yellow-100" width="w-80px" height="h-80px" rounded="rounded-lg" border="border-2"/>
      </div>
      <br className="h-28px" />
      <h1 className="font-extrabold mb-2 text-blue pl-6 text-xl">
      ...
      <br className="h-28px" />
      <div className="pl-6">
        <RadioButtonChecklist width1="w-32px" height1="h-32px" width2="w-16px" height2="h-16px" color1="bg-yellow" />
      </div>
      <br className="h-28px" />
      <h1 className="font-extrabold mb-2 text-black pl-6">
        Check Box
      ...
      <br className="h-28px" />
      <div className="pl-6">
        <CheckBoxBorder width1="w-32px" height1="h-32px" width2="w-16px" height2="h-16px" color1="bg-yellow" />
      </div>
      <br className="h-28px" />
      <h1 className="font-extrabold mb-2 text-black pl-6">
        Toggle Switch
      ...
      <br className="h-28px" />
      <div className={`pb-4 pl-6 ${var_ToggleOff === "visible" ? "visible" : "hidden"}`} onClick={handleClick}>
      <ToggleOff color="bg-black-400"/>
      </div>
      <div className={`pb-4 pl-6 ${var_ToggleOn === "hidden" ? "hidden" : "visible"}`} onClick={handleClick}>
      ...
      <Tags tittle="Tag name" width="w-81px" height="h-36px" color="bg-white font-extrabold text-xs pt-1" border="border-2 border-black" rounded="rounded-full" />
      </div>
      <div className="pb-4 pl-6">
      <TagsCross tittle="Active name" width="w-125px" height="h-36px" color="bg-pink-800 font-extrabold text-xs pt-1" border="border-2 border-black" rounded="rounded-full" />
      </div>
      <div className="pl-6">
      <Tags tittle="99+" width="w-32px" height="h-24px" color="bg-red font-extrabold text-xs text-white" border="border-2 border-black" rounded="rounded-full" />
      </div>
      {/* <ToggleSwitch />
      <Tags /> */}
      <br className="h-28px" />
      ...
      <br className="h-28px" />
      <div className="pl-6">
      <Slidder width="w-8px" height="h-8px" color1="bg-yellow" color2="bg-white" color3="bg-white" />
      </div>
      <br className="h-28px" />
      <div className="pl-6">
      <Slidder width="w-12px" height="h-12px" color1="bg-yellow" color2="bg-white" color3="bg-white" />

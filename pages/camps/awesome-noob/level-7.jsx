...
const Landing7 = () => {
  ...
  useEffect(() => {
    if (successModal === true) {
      ...
      confetti.render()
      setTimeout(() => {
        router.push('/camps/awesome-noob/level-8')
        confetti.clear()
      }, 5000)
      setTimeout(() => {
        PostData()
    ...
    <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black-400 p-4 z-30">
        <div className="opacity-100 text-black">
          <p className="font-black">MISI KALI INI EMANG AKAN MENGAMBIL BAJU ASTRONOT</p>
        </div>
...
const ToastFailure = () => {
  return (
    <div className="flex flex-row w-[200px] m-5 justify-start items-center border-2 border-black bg-black rounded-lg p-1">
      <div>

...
const WallOfTextLayoutAlt = ({ children, frontMatter }) => {
  ...
  return (
    <>
      ...
      <article className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full p-4">
        <div className="pt-8 pb-8 prose dark:prose-dark max-w-none xl:col-span-2 font-mono text-sm">
          {children}
        </div>
      </article>
    </>
...
export default WallOfTextLayoutAlt

...
export default function PrimitivePage() {
  return (
    <div>
      <br className="h-[28px]" />
      <h1 className="font-extrabold mb-2 text-blue text-lg pl-6">T Y P O G R A P H Y</h1>
      <br className="h-[28px]" />
      <h1 className="font-normal mb-2 text-black text-lg pl-6">Primary Typeface</h1>
      ...
      <br className="h-[28px]" />
      <h1 className="font-bold mb-2 text-black text-lg pl-6">Download</h1>
      <div className="pl-6 pb-4">
        <Download />
      </div>
      <br className="h-[28px]" />
      <h1 className="font-extrabold mb-2 text-blue text-lg pl-6">S P A C I N G</h1>
      <br className="h-[28px]" />
      <div className="flex">
      ...
      <br className="h-[28px]" />
      <h1 className="font-extrabold mb-2 text-blue text-lg pl-6">S E P R A T O R</h1>
      <Seprator />
      <br className="h-[28px]" />
      <h1 className="font-extrabold mb-2 text-blue text-lg pl-6">C O L O R S</h1>
      <div className="flex-1 pl-6">
      ...
      <br className="h-[28px]" />
      <h1 className="font-extrabold mb-2 text-blue text-lg pl-6">D O C U M E N T A T I O N</h1>
      <Documentation />
    </div>
  )
}

    ...
    <div className="flex flex-col bg-black-200">
          ...
          <div className="flex flex-row mt-9 ml-6">
            <div>
              ...
              >
                ...
                <path
                  d="M23.1109 10.6666L13.3331 20.4444L8.88867 16"
                  stroke="white"
                  strokeWidth="3"
                  strokeLinecap="round"
                  strokeLinejoin="round"
      ...
      <div className="flex flex-col border-2 border-black w-[279px] h-[156px] bg-yellow-100 m-5 rounded-2xl">
        <div className="flex flex-col ml-6 mt-6">
          ...
          <div className="flex flex-row mt-3">
            <button className="w-[109px] h-[36px] rounded-xl bg-white text-black font-extrabold border-2 border-black text-xs">
              Cancel
            </button>
            <button className="ml-3 w-[109px] h-[36px] rounded-xl bg-black text-white font-extrabold border-2 border-black text-xs">
              Okay
            </button>
          </div>
        </div>
      ...
      <div className="flex flex-col border-2 border-black w-[279px] h-[156px] bg-yellow-100 m-5 rounded-2xl">
        <div className="flex flex-col ml-6 mt-6">
          ...
          <div className="flex flex-row mt-3">
            <button className="w-[231px] h-[36px] rounded-xl bg-black text-white font-extrabold border-2 border-black text-xs">
              Okay
            </button>
          </div>
        </div>

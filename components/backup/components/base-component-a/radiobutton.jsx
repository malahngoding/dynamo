      ...
      <div className="pr-24">
        <div className="flex justify-items-center" onClick={handleClick}>
          <div className="flex -mr-6 items-center">
            <button className={`${width1} ${height1} border ${color1} rounded-full `}></button>
          </div>
          <div className="flex items-center">
            <div className={`${width2} ${height2} border ${color2}  rounded-full`}></div>
          </div>
        </div>
      </div>
    </div>
...
export function RadioButtonChecklist(props) {
      ...
      <div className="pr-24">
        <div className="flex justify-items-center" onClick={handleClick}>
          <div className="flex -mr-7 items-center">
            <button className={`${width1} ${height1} ${color1} rounded-full`}></button>
          </div>
          <div className="flex items-center">
            <svg
              width="22"

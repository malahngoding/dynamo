...
export const TabBar = () => {
  ...
  return (
    <div className="flex flex-row justify-evenly border-2 border-black my-2 w-[375px] bg-white">
      <button
        className="flex flex-col text-sm justify-center items-center m-4 hover:cursor-pointer"
      ...
      >
        ...
        >
          <circle
            ...
            cy="12"
            r="11"
            fill={activeTab === 1 ? '#00C6AE' : '#EEEFF4'}
            stroke="#474A57"
            strokeWidth="2"
          />
        </svg>
      ...
      >
        ...
        >
          <circle
            ...
            cy="12"
            r="11"
            fill={activeTab === 2 ? '#00C6AE' : '#EEEFF4'}
            stroke="#474A57"
            strokeWidth="2"
          />
        </svg>
      ...
      >
        ...
        >
          <circle
            ...
            cy="12"
            r="11"
            fill={activeTab === 3 ? '#00C6AE' : '#EEEFF4'}
            stroke="#474A57"
            strokeWidth="2"
          />
        </svg>
      ...
      >
        ...
        >
          <circle
            ...
            cy="12"
            r="11"
            fill={activeTab === 4 ? '#00C6AE' : '#EEEFF4'}
            stroke="#474A57"
            strokeWidth="2"
          />
        </svg>

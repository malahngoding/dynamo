    ...
    <div className="flex flex-col bg-green-100">
      <div>
        ...
        <form>
          <div className="h-[414px] w-[375px] m-5 border-2 border-white bg-white">
            <p className="mt-6 mx-6 w-[327px] h-[40px] text-4xl text-black font-sans text-center font-extrabold">
              Login
            </p>
      ...
      <div>
        <form>
          <div className="h-[530px] w-[375px] m-5 border-2 border-white bg-white">
            ...
            <p className="mx-6 mt-3 font-normal text-base">You have chance to create new</p>
            <p className="mx-6 font-normal text-base">account if you really want to.</p>
            <div className="flex flex-row border-2 border-black mx-6 mt-6 w-[327px] h-[56px] rounded-2xl box-border">
              <div>
                <svg
                  className="my-3 mx-3"
      ...
      <div className="flex flex-col border-2 border-white bg-white w-[375px] h-[224px] m-5 items-stretch">
        ...
        <div className="flex flex-row mx-6 mt-6 items-stretch px-10">
          <p className="text-black font-sans text-sm font-normal text-center">
            Didnt&apos;t get fav number?
          </p>
          <p className="text-red font-sans text-sm font-bold ml-1">Get new</p>
        </div>
        <button className="mt-5 mx-6 w-[327px] h-[60px] rounded-2xl bg-black text-white font-sans text-xl font-extrabold">
          Verify
        </button>
      </div>
      ...
      <div>
        <form>
          <div className="h-[478px] w-[375px] m-5 border-2 border-white bg-white">
            ...
            <p className="mx-6 font-normal text-base">and behave like human not robot.</p>
            <div className="flex flex-row border-2 border-black mx-6 mt-6 w-[327px] h-[56px] rounded-2xl box-border">
              <div>
                <svg
                  className="my-3 mx-3"
            ...
            <button className="mt-12 mx-6 w-[327px] h-[60px] rounded-2xl bg-yellow text-black border-2 border-black font-sans text-xl font-extrabold box-border shadow-lg ">
              Sign in
            </button>
      ...
      <div className="flex flex-col border-2 border-black w-[375px] h-[340px] bg-white m-5 rounded-t-lg">
        <div className="flex flex-row border-b-2 border-black">
          <div className="flex flex-1 font-sans font-extrabold text-xl mr-12 my-4 ml-6 h-[28px] w-[302px]">
            Welcome Back
          </div>
          <svg
            className="mr-6 mt-4"
...
export const SignUpFormYellow = () => {
  const [var_ValidationEmail, setValidationEmail] = useState('')
  const [var_ValidationPassword, setValidationPassword] = useState('')
  const [var_ValidationFullname, setValidationFullname] = useState('')
  ...
  //         name: var_ValidationFullname,
  //         email: var_ValidationEmail,
  //         password: var_ValidationPassword,
  //       })
  //       .then((response) => {
          ...
          .then(
            (response) => {
              ...
              axios.get(hostName + 'api/user').then(
                ...
                // GET USER ERROR
                (error) => {
                  console.error('Could not complete the register')
                }
              )
            },
            // LOGIN ERROR
  ...
  return (
    <div className="h-[530px] w-[360px] md:w-[375px] md:m-5 border-2 border-white bg-white flex flex-col justify-center items-center rounded-xl">
      <PageLayout>
        <p className="mt-14 mx-6 w-[327px] h-[40px] text-4xl text-black font-sans font-extrabold">
          Sign Up
        </p>
        ...
        <div className="flex flex-row border-2 border-black mx-6 mt-6 w-[327px] h-[56px] rounded-2xl box-border">
          ...
          <div>
            <input
              ...
              onChange={(event) => {
                setValidationFullname(event.target.value)
              }}
              value={var_ValidationFullname}
            />
          </div>
        </div>
        <div className="flex flex-row border-2 border-black mx-6 mt-6 w-[327px] h-[56px] rounded-2xl box-border">
        ...
        <div className="flex flex-row border-2 border-black mx-6 mt-6 w-[327px] h-[56px] rounded-2xl box-border">
          ...
          <div>
            <input
              ...
              value={var_ValidationPassword}
            />
          </div>
        </div>
        <button
          className="mt-8 py-4 mx-6 w-[327px] h-[60px] rounded-2xl bg-yellow text-black border-2 border-black font-sans text-xl font-extrabold box-border shadow-lg "
          onClick={handleClick}
        >
          Sign up
        </button>
    ...
    <form>
      <div className=" xs:m-2 border-2 lg:border-0 border-b-8 lg:border-b-0 border-black bg-white p-2 lg:p-6 rounded-xl">
        <div className="ml-3 xs:mx-6 pt-6">
          <CircleButtonBack
            width="w-[45px] lg:w-[60px]"
            height="h-[45px] lg:h-[60px]"
            color="bg-white"
            border="border-2 border-b-4"
            rounded="rounded-full"
          />
        </div>
        <p className="mt-3  ml-6 text-4xl text-black font-sans text-start  font-extrabold">
          Lupa Password
        </p>
        ...
        <div className="flex flex-row border-2 border-black mx-6 mt-2 lg:mt-6 lg:w-[327px] lg:h-[56px] rounded-2xl">
          ...
          <div>
            <input
              className="border-0 focus:border-yellow my-1 w-full rounded-xl lg:w-[251px] lg:h-[28px] lg:my-3"
              name="email"
              type="text"
              placeholder="Email address"
            />

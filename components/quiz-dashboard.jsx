...
export const QuizDashboardPages = (props) => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-col-reverse border-4 md:border-0 border-black bg-white rounded-3xl m-5 md:m-0 w-[375px] md:w-full">
        <div className="flex flex-col-reverse md:flex-row justify-start md:justify-end">
          <div className="flex flex-col border-4 border-purple-400 mx-5 bg-purple-400 rounded-lg md:w-[350px] md:h-[210px]">
          ...
          <div className="flex flex-row mt-0 border-4 border-green mx-5 bg-green m-6 rounded-3xl md:hidden">
              ...
              <div className="flex flex-row border-4 border-yellow-100 mx-5 bg-yellow-100 m-6 rounded-3xl">
                <div className="flex flex-1">
                  <div className="flex flex-col justify-center">
                    ...
                    <div className="mt-1 ml-3 mb-3 font-bold ">
                      {currentQuestionGroup.groupname}
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="md:grid md:grid-cols-5 md:gap-4">
            {props.rankings.map((item, index) => (
              <>
                <div className="flex flex-row border-4 border-white bg-white mx-5 mt-5" key={index}>
                  ...
                  <div className="flex flex-1  mx-5 mt-2">
                    <div className="flex flex-col">
                      <div className="text-black font-bold uppercase break-word">{item.name}</div>

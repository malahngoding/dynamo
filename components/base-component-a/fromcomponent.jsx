        ...
        <div className="grid pl-6 pb-4 bg-green-100">
            ...
            <div className="pb-2 inline-block">
                <div className="flex border rounded bg-white items-center p-3 w-52 h-7">
                    <svg className="pr-1" width="22" height="18" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input className="bg-white w-40 h-5 focus:outline-none text-base font-normal placeholder-black" type="text" placeholder="Input your love here"/>
                </div>
            </div>
            <div className="pb-2 inline-block">
                <div className="flex border rounded bg-white items-center p-3 w-52 h-7">
                    <input className="pr-1 bg-white w-40 h-4 focus:outline-none text-base font-normal placeholder-black" type="text" placeholder="Search with love ..."/>

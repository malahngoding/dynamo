    ...
    return (
      <div>
        <button className={`flex flex-row ${border} ${rounded} ${width} ${height} shadow-xl ${color} justify-center`}>
            ...
            <path d="M27.8332 14H2.1665" stroke={`${color_img}`} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10.3332 22.1666L2.1665 14L10.3332 5.83331" stroke={`${color_img}`} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </button>
      </div>
    );
  ...
  export function CircleButtonChevron(props) {
    ...
    return (
      <div>
        ...
        <path d="M18.6665 24L10.6665 16L18.6665 8" stroke={`${color_img}`} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
  ...
  export function CircleButtonClose(props) {
    ...
    return (
      <div>
        ...
        <path d="M15 5L5 15" stroke={`${color_img}`} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M5 5L15 15" stroke={`${color_img}`} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
